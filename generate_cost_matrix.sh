...
# For ImageNet
# CUDA_VISIBLE_DEVICES=$gpu python tools/generate_class_proto.py --model resnet32x4
# CUDA_VISIBLE_DEVICES=$gpu python tools/generate_cost_matrix.py --model resnet32x4
...
# For CIFAR-100
CUDA_VISIBLE_DEVICES=$gpu python tools/generate_class_proto.py --model resnet32x4 --dataset cifar100 --ckpt download_ckpts/cifar_teachers/resnet32x4_vanilla/ckpt_epoch_240.pth --feature_type logit
