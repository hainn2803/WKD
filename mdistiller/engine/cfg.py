...
CFG.MD.LOSS.CE_WEIGHT = 1.0
CFG.MD.LOSS.WKD_LOGIT_WEIGHT = 1.0
CFG.MD.LOSS.WKD_FEAT_WEIGHT = 1.0
CFG.MD.LOSS.COSINE_DECAY_EPOCH = 0

CFG.MD.INPUT_SIZE=(224, 224)
CFG.MD.TEMPERATURE = 4.
CFG.MD.COST_MATRIX = ""
CFG.MD.COST_MATRIX_PATH = ""
CFG.MD.COST_MATRIX_SHARPEN = 1.0
CFG.MD.SINKHORN = CN()
CFG.MD.SINKHORN.LAMBDA = 0.05
CFG.MD.SINKHORN.ITER = 10

CFG.MD.EPS=0.00001
CFG.MD.HINT_LAYER = 4
CFG.MD.MEAN_COV_RATIO = 2.0
CFG.MD.PROJECTOR = 'bottleneck'
CFG.MD.SPATIAL_GRID = 4
