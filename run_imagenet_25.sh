#!/bin/bash -e
#SBATCH --job-name=img_25inter
#SBATCH --output=/lustre/scratch/client/movian/research/users/hainn14/WKD/spp_noti/imagenet_25inter.out
#SBATCH --error=/lustre/scratch/client/movian/research/users/hainn14/WKD/spp_noti/imagenet_25inter.err
#SBATCH --nodes=1
