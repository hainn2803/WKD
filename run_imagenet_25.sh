#!/bin/bash -e
#SBATCH --job-name=img_25multi
#SBATCH --output=/lustre/scratch/client/movian/research/users/hainn14/WKD/spp_noti/imagenet_25multi.out
#SBATCH --error=/lustre/scratch/client/movian/research/users/hainn14/WKD/spp_noti/imagenet_25multi.err
#SBATCH --nodes=1
